...
Останній етап потрібен для постійного покращення та відшліфування процесу IR. Коли ви дістанетесь сюди в реальності, ви інтуїтивно розумітимете які саме були проблеми та помилки, що саме могло піти краще. Найпоширенішими помилками є наступні:  
